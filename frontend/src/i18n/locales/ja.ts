...
export default {
  ...
  errors: {
    ...
    social_failed: 'ソーシャルログインに失敗しました。しばらくしてから再度お試しください。',
    social_not_configured: 'ソーシャルログインはまだ設定されていません。',
    invalid_state: 'リクエストの有効期限が切れました。もう一度お試しください。',
    invalid_platform: 'サポートされていないリクエストです。',
    invalid_return: '許可されていないアドレスです。',
